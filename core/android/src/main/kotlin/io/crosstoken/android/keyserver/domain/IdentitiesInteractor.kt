package io.crosstoken.android.keyserver.domain

import io.crosstoken.android.internal.common.crypto.kmr.KeyManagementRepository
import io.crosstoken.android.internal.common.exception.AccountHasDifferentStatementStored
import io.crosstoken.android.internal.common.exception.AccountHasNoCacaoPayloadStored
import io.crosstoken.android.internal.common.exception.AccountHasNoIdentityStored
import io.crosstoken.android.internal.common.exception.InvalidAccountIdException
import io.crosstoken.android.internal.common.exception.InvalidIdentityCacao
import io.crosstoken.android.internal.common.exception.UserRejectedSigning
import io.crosstoken.android.internal.common.jwt.did.EncodeDidJwtPayloadUseCase
import io.crosstoken.android.internal.common.jwt.did.EncodeIdentityKeyDidJwtPayloadUseCase
import io.crosstoken.android.internal.common.jwt.did.encodeDidJwt
import io.crosstoken.android.internal.common.model.AccountId
import io.crosstoken.android.internal.common.model.DidJwt
import io.crosstoken.android.internal.common.model.MissingKeyException
...
import io.crosstoken.android.internal.common.signing.cacao.getStatement
import io.crosstoken.android.internal.common.signing.cacao.toCAIP222Message
import io.crosstoken.android.internal.common.storage.identity.IdentitiesStorageRepository
import io.crosstoken.android.internal.utils.getIdentityTag
import io.crosstoken.android.keyserver.domain.use_case.RegisterIdentityUseCase
import io.crosstoken.android.keyserver.domain.use_case.ResolveIdentityUseCase
import io.crosstoken.android.keyserver.domain.use_case.UnregisterIdentityUseCase
...
import io.crosstoken.foundation.util.jwt.DID_DELIMITER
