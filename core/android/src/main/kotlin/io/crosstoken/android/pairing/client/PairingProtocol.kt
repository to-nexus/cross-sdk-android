...
package io.crosstoken.android.pairing.client
...
internal class PairingProtocol(private val koinApp: KoinApplication = wcKoinApp) : PairingInterface {
    ...
    @Deprecated(message = "Ping method has been deprecated. It will be removed soon. Please use Ping from Sign clients.")
    @Throws(IllegalStateException::class)
