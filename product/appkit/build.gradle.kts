...
android {
    namespace = "io.crosstoken.appkit"
...
dependencies {
    ...
    releaseImplementation("io.crosstoken:android-core:$CORE_VERSION")
    releaseImplementation("io.crosstoken:sign:$SIGN_VERSION")
    releaseImplementation("io.crosstoken:modal-core:$MODAL_CORE_VERSION")
