package io.crosstoken.appkit.client
...
import io.crosstoken.appkit.client.models.AppKitClientAlreadyInitializedException
...
import io.crosstoken.appkit.di.appKitModule
import io.crosstoken.appkit.domain.delegate.AppKitDelegate
import io.crosstoken.appkit.domain.model.Session.WalletConnect
...
object AppKit {
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith("io.crosstoken.appkit.client.AppKit.getAccount()"),
