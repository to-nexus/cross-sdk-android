...
import io.crosstoken.appkit.ui.components.internal.root.rememberAppKitRootState
...
internal abstract class ScreenShotTest(
    ...
    fun runComponentScreenShotTest(
        ...
        snapshot {
            ProvideAppKitThemeComposition {
                Box(modifier = Modifier.background(AppKitTheme.colors.background.color100)) {
