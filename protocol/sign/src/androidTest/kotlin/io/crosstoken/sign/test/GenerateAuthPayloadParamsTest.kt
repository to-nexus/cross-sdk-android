package io.crosstoken.sign.test

import io.crosstoken.android.internal.common.signing.cacao.getChains
import io.crosstoken.android.internal.common.signing.cacao.getMethods
...
class GenerateAuthPayloadParamsTest {
    ...
    fun testHandlingSupportedRequestedChainsAndMethodsInTwoReCapsWithOneUrns() {
        ...
        println(result.resources)
        assert(
            result.resources == listOf(
                "test_resource",
                "urn:recap:"
            )
        )
    }
    ...
    fun testHandlingSupportedRequestedChainsAndMethodsInOneReCapsWithTwoUrns() {
        ...
        val result = generateAuthPayloadParams(requestedPayload, supportedChains = listOf("eip155:137"), supportedMethods = listOf("personal_sign"))
        val sessionChains = result.resources.getChains().ifEmpty { requestedPayload.chains }
        val sessionMethods = result.resources.getMethods()
        ...
        assert(
            result.resources == listOf(
                "test_resource",
                "urn:recap:",
                "urn:recap:eyJhdHQiOnsiZWlwMTU1Ijp7InJlcXVlc3QvcGVyc29uYWxfc2lnbiI6W3siY2hhaW5zIjpbImVpcDE1NToxMzciXX1dfX19"
            )
        )
    }
