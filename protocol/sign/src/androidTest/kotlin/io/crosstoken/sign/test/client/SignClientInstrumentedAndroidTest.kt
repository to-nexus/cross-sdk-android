package io.crosstoken.sign.test.client

import io.crosstoken.android.Core
import io.crosstoken.sign.BuildConfig
import io.crosstoken.sign.client.Sign
import io.crosstoken.sign.client.SignClient
import io.crosstoken.sign.test.scenario.SignClientInstrumentedActivityScenario
import io.crosstoken.sign.test.utils.TestClient
import io.crosstoken.sign.test.utils.dapp.AutoApproveDappDelegate
import io.crosstoken.sign.test.utils.dapp.DappDelegate
import io.crosstoken.sign.test.utils.dapp.DappSignClient
import io.crosstoken.sign.test.utils.dapp.dappClientConnect
import io.crosstoken.sign.test.utils.dapp.dappClientSendRequest
import io.crosstoken.sign.test.utils.globalOnError
import io.crosstoken.sign.test.utils.sessionChains
import io.crosstoken.sign.test.utils.sessionEvents
import io.crosstoken.sign.test.utils.sessionNamespaceKey
import io.crosstoken.sign.test.utils.wallet.AutoApproveSessionWalletDelegate
import io.crosstoken.sign.test.utils.wallet.WalletDelegate
import io.crosstoken.sign.test.utils.wallet.WalletSignClient
import io.crosstoken.sign.test.utils.wallet.dappClientExtendSession
import io.crosstoken.sign.test.utils.wallet.rejectOnSessionProposal
import io.crosstoken.sign.test.utils.wallet.walletClientEmitEvent
import io.crosstoken.sign.test.utils.wallet.walletClientExtendSession
import io.crosstoken.sign.test.utils.wallet.walletClientRespondToRequest
import io.crosstoken.sign.test.utils.wallet.walletClientUpdateSession
