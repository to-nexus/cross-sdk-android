package io.crosstoken.sign.validator
...
import io.crosstoken.sign.common.exceptions.EMPTY_NAMESPACES_MESSAGE
import io.crosstoken.sign.common.exceptions.INVALID_EVENT_MESSAGE
import io.crosstoken.sign.common.exceptions.INVALID_EXTEND_TIME
import io.crosstoken.sign.common.exceptions.INVALID_REQUEST_MESSAGE
import io.crosstoken.sign.common.exceptions.NAMESPACE_ACCOUNTS_CAIP_10_MESSAGE
import io.crosstoken.sign.common.exceptions.NAMESPACE_ACCOUNTS_WRONG_NAMESPACE_MESSAGE
import io.crosstoken.sign.common.exceptions.NAMESPACE_CHAINS_CAIP_2_MESSAGE
import io.crosstoken.sign.common.exceptions.NAMESPACE_CHAINS_MISSING_MESSAGE
import io.crosstoken.sign.common.exceptions.NAMESPACE_CHAINS_UNDEFINED_MISSING_MESSAGE
import io.crosstoken.sign.common.exceptions.NAMESPACE_CHAINS_WRONG_NAMESPACE_MESSAGE
import io.crosstoken.sign.common.exceptions.NAMESPACE_EVENTS_MISSING_MESSAGE
import io.crosstoken.sign.common.exceptions.NAMESPACE_KEYS_INVALID_FORMAT
import io.crosstoken.sign.common.exceptions.NAMESPACE_KEYS_MISSING_MESSAGE
import io.crosstoken.sign.common.exceptions.NAMESPACE_METHODS_MISSING_MESSAGE
import io.crosstoken.sign.common.exceptions.UNAUTHORIZED_EVENT_MESSAGE
import io.crosstoken.sign.common.exceptions.UNAUTHORIZED_METHOD_MESSAGE
...
import io.crosstoken.sign.engine.model.mapper.toAbsoluteString
import io.crosstoken.sign.validator.ValidatorTest.Accounts.COSMOSHUB_4_1
import io.crosstoken.sign.validator.ValidatorTest.Accounts.ETHEREUM_1
import io.crosstoken.sign.validator.ValidatorTest.Accounts.ETHEREUM_2
import io.crosstoken.sign.validator.ValidatorTest.Accounts.ETHEREUM_3
import io.crosstoken.sign.validator.ValidatorTest.Accounts.ETHEREUM_4
import io.crosstoken.sign.validator.ValidatorTest.Accounts.ETHEREUM_5
import io.crosstoken.sign.validator.ValidatorTest.Accounts.KOVAN_1
import io.crosstoken.sign.validator.ValidatorTest.Accounts.MATIC_1
import io.crosstoken.sign.validator.ValidatorTest.Chains.COSMOSHUB_4
import io.crosstoken.sign.validator.ValidatorTest.Chains.ETHEREUM
import io.crosstoken.sign.validator.ValidatorTest.Chains.KOVAN
import io.crosstoken.sign.validator.ValidatorTest.Chains.MATIC
import io.crosstoken.sign.validator.ValidatorTest.Chains.OPTIMISM
import io.crosstoken.sign.validator.ValidatorTest.Events.ACCOUNTS_CHANGED
import io.crosstoken.sign.validator.ValidatorTest.Events.CHAIN_CHANGED
import io.crosstoken.sign.validator.ValidatorTest.Events.COSMOS_EVENT
import io.crosstoken.sign.validator.ValidatorTest.Events.SOME_EVENT
import io.crosstoken.sign.validator.ValidatorTest.Methods.COSMOS_GET_ACCOUNTS
import io.crosstoken.sign.validator.ValidatorTest.Methods.COSMOS_SIGNDIRECT
import io.crosstoken.sign.validator.ValidatorTest.Methods.ETH_SIGN
import io.crosstoken.sign.validator.ValidatorTest.Methods.PERSONAL_SIGN
import io.crosstoken.sign.validator.ValidatorTest.Namespaces.COSMOS
import io.crosstoken.sign.validator.ValidatorTest.Namespaces.EIP155
